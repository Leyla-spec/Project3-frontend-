...
// let sliderOne = document.getElementById("areaMin");
// let sliderTwo = document.getElementById("areaMax");
// let displayValOne = document.getElementById("range1");
// let displayValTwo = document.getElementById("range2");
// let minGap = 0;
// let sliderTrack = document.querySelector(".area-range");
// let sliderMaxValue = document.getElementById("areaMin").max;
